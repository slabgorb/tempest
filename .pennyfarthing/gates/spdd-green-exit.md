<gate name="spdd-green-exit" model="haiku">

<purpose>
Composite gate for Dev GREEN-phase handoff in the SPDD workflow.
...
The GREEN phase of the SPDD workflow requires attestation for:
